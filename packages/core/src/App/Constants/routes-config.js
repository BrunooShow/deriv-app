...
const modules = [
...

    {
        ...
        // routes: [
        //     // { path: routes.bot, component: Bot, title: localize('Bot'), is_authenticated: true },
        //     { path: routes.contract, component: Bot, title: localize('Contract Details'), is_authenticated: true },
        //     { path: routes.error404, component: Bot, title: localize('Error 404') },
        // ],
    },
];
